...
map.getView().fit([-11066767.520294, 2183648.691486, -11003663.699725, 2217517.596812], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Tipos de extorsión (1 ene 2023 - 15 oct 2024)</h2>';
        return titleElement;
    })(),
